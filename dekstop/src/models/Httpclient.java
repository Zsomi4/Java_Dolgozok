...
public class Httpclient {
    ...
    public String tryGetRequest(String urlStr) throws IOException {
    ...
    public String postRequest(String url, String data, HashMap<String, String> headers) {
        String result;
        try {
            result = tryPostRequest(url, data, headers);
        } catch (IOException e) {
    ...
    public String tryPostRequest(String urlStr, String data, HashMap<String, String> headers) 
            throws IOException {
        URL url = new URL(urlStr);
        HttpURLConnection http = (HttpURLConnection) url.openConnection();
